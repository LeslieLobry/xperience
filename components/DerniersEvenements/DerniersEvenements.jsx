...
export default function DerniersEvenements() {
  ...
  if (!evenements.length) return <div>
    <h2 className="events-title">Derniers événements</h2> <span class="teasing">Préparez-vous... de nouvelles <strong>xperiences</strong> arrivent <span className="pulse">💫</span></span>
