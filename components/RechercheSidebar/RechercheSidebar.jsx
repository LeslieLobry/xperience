  ...
  return (
    <aside className="recherche-sidebar">
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        />
        {resumeVocal && (
          <div style={{ margin: "12px 0 20px 0", padding: "12px 20px", borderRadius: 8, background: "#fffbe7", color: "#c4903a", fontWeight: "bold", fontSize: 17, boxShadow: "0 2px 10px #e0c08444", maxWidth: 700 }}>
      ...
      <form onSubmit={handleSubmit}>
        <input type="text" name="pseudo" className="input-recherche" placeholder="Pseudo" value={form.pseudo} onChange={handleChange} />
        ...
        <Section title="Identité" open={openSections.identite} toggle={() => toggleSection("identite")}>
          ...
          {renderCheckboxGroup("Type de recherche", "rechercheType", ["Je le garde pour moi", "Virtuel uniquement", "Virtuel et peut-être plus", "Réel seulement", "Réel & Virtuel", "Je ne sais pas, c’est à voir", "Aventure d’un soir", "Relation secrète", "Relation à long terme"])}
        </Section>

        <Section title="Recherches" open={openSections.criteres} toggle={() => toggleSection("criteres")}>
          {renderCheckboxGroup("Je recherche", "recherches", ["Hommes hétéros", "Femmes hétéros", "Couples hétéros", "Couples F Bi", "Couples H Bi", "Couples Bi", "Hommes Bi", "Gays", "Femmes Bi", "Lesbiennes", "Travestis", "Transgenres"])}
        </Section>

        <Section title="Envies" open={openSections.envies} toggle={() => toggleSection("envies")}>
          {renderCheckboxGroup("Mes envies", "envies", ["2+2", "BDSM", "Cam", "Candaulisme", "Chat", "Côte-à-côtisme", "Curieux", "Duo", "Echangisme", "Exhibition", "Extreme", "Feeling", "Fétichisme", "Gang bang", "Hard", "Mélangisme", "Papouilles", "Photos", "Pluralité", "Scénario", "Soft", "Trio", "Vidéos", "Voyeurisme"])}
        </Section>

        <Section title="Expérience" open={openSections.experience} toggle={() => toggleSection("experience")}>
          {renderCheckboxGroup("Expérience", "experience", ["A découvrir", "Débutant", "Occasionnel", "Expérimenté", "Je la garde pour moi"])}
        </Section>
        ...
        <Section title="Autres critères" open={openSections.autres} toggle={() => toggleSection("autres")}>
          ...
          {renderCheckboxGroup("Yeux", "yeux", ["Bleu", "Bleus", "Vert", "Verts", "Marron", "Noir", "Noirs", "Gris", "Noisette"])}
          {renderCheckboxGroup("Cheveux", "cheveux", ["Blond", "Blonds", "Brun", "Bruns", "Noir", "Noirs", "Roux", "Châtain", "Châtains", "Gris", "Rasé", "Rasés", "Long", "Longs", "Court", "Courts"])}
        </Section>
