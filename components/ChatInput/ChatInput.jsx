  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        formData.append("type", isEph ? "EPHEMERE" : "IMAGE");
      ...
      if (audioBlob) {
        ...
        formData.append("conversationId", conversationId);
        formData.append("type", isEph ? "EPHEMERE" : "AUDIO");
      ...
      // ✅ RESET UI IMMÉDIAT (le message ne reste plus dans l’input)
      setTexte("");
      setEphemere(false);
      setIsSending(false);
    ...
    <>
      ...
      <form className="chat-input" onSubmit={handleSubmitWithNotif}>
        <textarea
          ...
          style={{
            resize: "none",
            // ✅ plus de overflow hidden forcé ici
          }}
        />
        ...
        <div className="input-wrapper" style={{ alignItems: "center" }}>
          ...
          <label
            ...
            title="Envoyer une photo (normale)"
            style={{
          ...
          <button
            ...
            onClick={openPickerEphemere}
            title={imageFile ? "Basculer en éphémère" : "Envoyer une photo éphémère"}
          >
            <svg
              width="24px"
              height="24px"
        ...
        >
          {/* ✅ plus de “Envoi…” qui reste */}
          {imageFile
            ? ephemere
              ? "Envoyer l'image (éphémère)"
              : "Envoyer l'image"
            : audioBlob
              ? "Envoyer l'audio"
              : "Envoyer"}
        ...
        <div className="emoji-picker-container">
          <Picker
            ...
            onEmojiSelect={(emoji) => {
              ...
              requestAnimationFrame(autoResize); // ✅ important
            }}
            theme="light"
          />
        </div>
